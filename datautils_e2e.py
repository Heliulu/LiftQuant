...
def make_data_module(tokenizer: transformers.PreTrainedTokenizer, args) -> Dict:
    ...
    def load_data(dataset_name):
        if dataset_name == 'alpaca':
            ...
            dataset = load_dataset("allenai/c4","allenai--c4", cache_dir = "../dataset/c4",
                data_files={
            ...
            dataset = load_dataset("ZengXiangyu/RedPajama-Data-1T-Sample", cache_dir = "/data/shared_data/datasets")  
            #dataset = load_dataset("togethercomputer/RedPajama-Data-1T-Sample", cache_dir = "../dataset/RedPajama-1T-Sample" )   
            if "validation" not in dataset.keys():
                validation_split = args.eval_dataset_size
                dataset["validation"] = load_dataset(
                    "ZengXiangyu/RedPajama-Data-1T-Sample", cache_dir = "/data/shared_data/datasets",
